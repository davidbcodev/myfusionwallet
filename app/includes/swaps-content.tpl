                    ...
                    <div class="row m-0">
                        ...
                        <div class="col-md-6 pl-2">
                            ...
                            >
                                ...
                                <div class="col-md-12 col-xs-12 p-1 mt-1 asset-dropdown ms-new-search-results-grp"
                                     ng-repeat="asset in assetListOwned | filter:searchSendAsset | filter: {verified: false} track by $index">
                                    <a ng-click="setSendAsset(asset.id)">
                                        ...
                                        <div class="col">
                                        <span class="fusion-text-14">{{asset.name}} ({{asset.symbol}})
                                ...
                                <div class="ms-new-search-results-title">VERIFIED ASSETS</div>
